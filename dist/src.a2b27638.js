...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/solution.js":[function(require,module,exports) {
"use strict";
...
var filterLaunches = function filterLaunches(list) {
  return list.filter(function (element) {
    var is2018 = element.launch_year === "2018";
    var hasNasa = false;
    element.rocket.second_stage.payloads.map(function (payload) {
...
var sortList = function sortList(list) {
  return list.sort(function (a, b) {
    var payloadA = a.rocket.second_stage.payloads.length;
    var payloadB = b.rocket.second_stage.payloads.length;
    ...
    var timeA = new Date(a.launch_date_utc);
    var timeB = new Date(b.launch_date_utc);
...
var fetchData = function fetchData() {
  _axios.default.get("https://api.spacexdata.com/v3/launches/past").then(function (response) {
    return renderData(prepareData(response.data));
  }).catch(function (error) {
    return console.log(error);
  });
};

var prepareData = function prepareData(response) {
  var data = filterLaunches(response);
  var result = sortList(data).map(function (element) {
    return {
...
var renderData = function renderData(result) {
